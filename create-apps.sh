...
node unitejs/unitejs-cli/bin/unite configure --packageName=polymer-typescript-amd --title="Polymer TypeScript CommonJS" --profile=PolymerTypeScript --moduleType=CommonJS --bundler=Webpack --outputDirectory=./apps/polymer-typescript-commonjs
